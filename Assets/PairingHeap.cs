...
//using System.Linq;
//public class PairingHeap<T> : Heap<T> where T : IComparable<T>
//{
//    public PairingHeap(T root, List<Heap<T>> children = null) : base(root, children)
//    {
//    }
...
//    public static PairingHeap<T> Meld(PairingHeap<T> heap1, PairingHeap<T> heap2)
//    {
//        if (heap1.IsEmpty)
//            return heap2;
//        if (heap2.IsEmpty)
...
//        {
//            return new PairingHeap<T>(heap1.elem, heap1.children.Prepend(heap2).ToList());
//        }
//        else
//        {
//            return new PairingHeap<T>(heap2.elem, heap1.children.Prepend(heap2).ToList());
//        }
//    }

//    public static PairingHeap<T> Insert()
//    {
...
//public class Heap<T>
//{
//    public Heap(T root, List<Heap<T>> children = null)
//    {
//        this.elem = root;
//        this.children = children ?? new List<Heap<T>>();
//    }
//    public T elem;
//    public List<Heap<T>> children;

//    public bool IsEmpty => elem == null;

//    public Heap(Heap<T> copy)
//    {
//        elem = copy.elem;
//        children = copy.children.ToList();
//    }
//}
...
/// <see cref="https://github.com/jlvermeulen/algorithms-and-data-structures/"/>
